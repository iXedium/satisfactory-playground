...
describe('Import Propagation Bug Tests', () => {
  it('should propagate production rate changes through import chains', async () => {
    ...
    const totalProduction = ironRodTreeAfterImport.amount + ironRodTreeAfterImport.excess;
    ...
    const newTotalProduction = finalIronRodTree.amount + finalIronRodTree.excess;
    ...
    const finalTotalProduction = finalIronRodTree2State.amount + finalIronRodTree2State.excess;
